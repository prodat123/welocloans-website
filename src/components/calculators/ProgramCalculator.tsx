    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start mb-6">
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-white border border-slate-200/70 rounded-2xl p-6 shadow-card">
          ...
          {/* Quick stats */}
          <div className="bg-white border border-slate-200/70 rounded-2xl p-6 shadow-card grid grid-cols-2 gap-4">
            {[
              {
      ...
      <div className="rounded-2xl overflow-hidden border border-slate-200/70 shadow-lg">
        ...
        <div className="bg-slate-800 px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <a
            href="/#contact"
            className="shrink-0 flex items-center gap-2 bg-white hover:bg-slate-100 text-slate-900 font-bold text-sm px-5 py-2.5 rounded-xl transition-all shadow-sm hover:shadow-md"
          >
            Get Pre-Qualified
            <svg
              width="14"
