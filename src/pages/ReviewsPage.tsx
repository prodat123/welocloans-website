...
const reviews = [
  ...
  },
  {
    ...
    translated: '"Speaking Vietnamese with their team made such a difference. I understood every step of the process. The LIPA program got me $90,000 in assistance — I couldn\'t believe it was possible for me."',
  },
  {
    name: 'James R.',
    location: 'Anaheim, CA',
    ...
    <div className="bg-transparent min-h-screen pt-28 pb-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mb-12 max-w-2xl">
          <p className="text-xs font-bold tracking-[0.12em] uppercase text-blue-600 mb-3">Client Reviews</p>
          <h1 className="text-5xl font-extrabold text-slate-900 tracking-tight mb-4">
            Real buyers. Real stories.
          </h1>
          <p className="text-lg text-slate-500 leading-relaxed">
            Don't take our word for it — here's what our clients have to say about buying their first home with WELOC Loans.
          </p>
        </div>
        ...
        <div className="bg-blue-700 rounded-2xl p-7 mb-12 flex flex-col sm:flex-row items-center gap-8">
          <div className="text-center sm:text-left shrink-0">
            <p className="text-7xl font-extrabold text-white leading-none">{avg}</p>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-blue-700 flex items-center justify-center shrink-0">
                    <span className="text-white font-extrabold text-sm">{r.name.charAt(0)}</span>
                  </div>
                  <div>
                ...
                <span className="text-[10px] text-slate-400 shrink-0 mt-0.5">{r.date}</span>
              </div>
              ...
              <div className="mt-4 flex-1">
                <p className="text-sm text-slate-600 leading-relaxed">
                  "{expanded === i ? r.text : r.text.slice(0, 140)}{r.text.length > 140 && expanded !== i ? '...' : ''}"
                </p>
                {r.translated && expanded === i && (
                  <p className="text-xs text-slate-400 italic mt-2 leading-relaxed">{r.translated}</p>
                )}
                {r.text.length > 140 && (
                  <button
        ...
        <div className="mt-14 text-center bg-slate-50 border border-slate-200 rounded-2xl p-10">
          <h3 className="text-2xl font-extrabold text-slate-900 mb-2">Did we help you get into your home?</h3>
          <p className="text-slate-500 text-sm mb-6">We'd love to hear your story — your review helps other first-time buyers take the leap.</p>
          <a
